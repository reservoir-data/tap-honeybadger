...
A full list of supported settings and capabilities is available by running: `tap-honeybadger --about`
...
You can also test the `tap-honeybadger` CLI interface directly:
